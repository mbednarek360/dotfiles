...
class ModeHandler {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            */
            ...
            if ((movement && !movement.doesntChangeDesiredColumn) ||
                (!movement && vimState.currentMode !== mode_1.Mode.VisualBlock)) {
    ...
    updateView(vimState, args = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // cursor style
            let cursorStyle = configuration_1.configuration.getCursorStyleForMode(this.currentMode);
            if (!cursorStyle) {
            ...
            */
            ...
            let searchRanges = [];
            if ((configuration_1.configuration.incsearch && this.currentMode === mode_1.Mode.SearchInProgressMode) ||
