...
function getAndUpdateModeHandler(forceSyncAndUpdate = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let [curHandler, isNew] = yield modeHandlerMap_1.ModeHandlerMap.getOrCreate(activeEditorId);
        if (isNew) {
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        globals_1.Globals.extensionStoragePath = context.globalStoragePath;
        ...
        registerEventListener(context, vscode.workspace.onDidSaveTextDocument, (document) => __awaiter(this, void 0, void 0, function* () {
            if (configuration_1.configuration.vimrc.enable &&
                path.relative(document.fileName, configuration_1.configuration.vimrc.path) === '') {
                yield configuration_1.configuration.load();
        ...
        registerEventListener(context, vscode.window.onDidChangeActiveTextEditor, () => __awaiter(this, void 0, void 0, function* () {
            ...
            taskQueue_1.taskQueue.enqueueTask(() => __awaiter(this, void 0, void 0, function* () {
                if (vscode.window.activeTextEditor !== undefined) {
                    ...
                    yield vscode_context_1.VsCodeContext.Set('vim.mode', mode_1.Mode[mh.vimState.currentMode]);
        ...
        registerCommand(context, 'vim.editVimrc', () => __awaiter(this, void 0, void 0, function* () {
            const document = yield vscode.workspace.openTextDocument(configuration_1.configuration.vimrc.path);
